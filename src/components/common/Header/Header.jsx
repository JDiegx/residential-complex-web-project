    ...
    return (
        <header className="header">
            ...
            <button className="header__button-menu" onClick={openMenu}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="header__button" viewBox="0 0 16 16">
            ...
            <aside className={`aside-menu ${isOpen ? '--open-menu' : ''}`}>
                <button className="aside-menu__close-btn" onClick={closeMenu}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="aside-menu__close-icon" viewBox="0 0 16 16">
